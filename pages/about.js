            ...
            <div className="grid place-items-center py-12 md:py-5 px-5 md:px-0">
                <div className="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden">
                    <div className='bg-bgDark'>
                        <Image className="w-full  object-cover object-center" height={275} width={400} src="https://res.cloudinary.com/dx3bsiydi/image/upload/v1624691489/profile_pvtcuz.jpg"  alt="avatar"/>
                    </div>
                    ...
                    <div className="py-4 px-6">
                        <h1 className="text-2xl font-semibold text-gray-800">Udit Kumar Anand</h1>
                        ...
                        <div className="flex items-center mt-4 text-gray-700">
                            ...
                            <h1 className="px-2 text-sm">uditanand84@gmail.com</h1>
                        </div>
                    </div>
                </div>
            </div>
